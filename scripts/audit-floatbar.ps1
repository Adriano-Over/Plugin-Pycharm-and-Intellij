...
$reportPath = Join-Path $reportDir "floatbar-audit.md"
$logDir = Join-Path $projectRoot "build\floatbar-audit-logs"
...
$focusedTestArgs = @(
    $offlineFlag
    "test"
    "--tests", "com.floatbar.architecture.SourceLayoutTest"
    "--tests", "com.floatbar.document.DrawingDocumentEditInteractionTest"
    "--tests", "com.floatbar.persistence.DrawingStrokeStoreTest"
    "--tests", "com.floatbar.persistence.FloatBarDrawingStateServiceTest"
    "--tests", "com.floatbar.geometry.PaintGeometryEngineTest"
    "--tests", "com.floatbar.geometry.ShapeStrokeFactoryTest"
    "--tests", "com.floatbar.geometry.BalloonTextStrokeFactoryTest"
    "--tests", "com.floatbar.ui.DrawingCanvasPanelStateTest"
    "--tests", "com.floatbar.ui.PhotoshopColorPickerPanelTest"
    "--tests", "com.floatbar.ui.FloatBarToolWindowMenuFilterTest"
    "--tests", "com.floatbar.ui.FloatingBarToolbarPanelTest"
    "--tests", "com.floatbar.ui.ShapeMenuFactoryTest"
    "--tests", "com.floatbar.ui.FloatingBarStateBinderTest"
)
...
try {
    ...
    $lines.Add("# FloatBar Audit Report")
    $lines.Add("")
    ...
    $lines.Add("- FloatBar is registered as a sidebar Tool Window without the duplicate status-bar widget or startup floating dialog.")
    $lines.Add("- FloatBar filters the native Tool Window View Mode popup down to Dock Pinned and Float when that IDE-owned menu is shown.")
    $lines.Add("- FloatBar registers a pencil icon and defaults text/balloon text to the filled style while keeping hollow text selectable.")
    ...
    $lines.Add("- FloatBar window positioning across multiple monitors.")
